...
namespace BMP1C.Net
{
    ...
    public interface IOleObject
    {
        ...
        //void EnumVerbs([MarshalAs(UnmanagedType.IUnknown), Out] out IEnumOLEVERB ppEnumOleVerb);
        ...
        //void SetExtent([In, MarshalAs(UnmanagedType.U4)] DVASPECT dwDrawAspect, [In, MarshalAs(UnmanagedType.Struct)] tagSIZEL psizel);
        //void GetExtent([In, MarshalAs(UnmanagedType.U4)] DVASPECT dwDrawAspect, [Out, MarshalAs(UnmanagedType.Struct)] out tagSIZEL psizel);
        void SetExtent(uint dwDrawAspect, [MarshalAs(UnmanagedType.LPStruct)] tagSIZEL psizel);
        void GetExtent(uint dwDrawAspect, [MarshalAs(UnmanagedType.LPStruct)] tagSIZEL psizel);
